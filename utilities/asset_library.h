...
#define BULLET_TEX_KEY       "bullet.png"
#define EXPLOSION_TEX_KEY    "explosion.png"
#define PARTICLE_MODEL_KEY   "particle"
...
public:
    ...
    static shared_ptr<mesh_t> quad_model();
    static string asteroid_tex_key(int index);
